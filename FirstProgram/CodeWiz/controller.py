...
render = web.template.render('Views/templates', base= "main-layout",globals={'session':session_data,'current_user':session_data['user']})
render2 = web.template.render('Views/templates', base= "html-tem",globals={'session':session_data,'current_user':session_data['user']})
